    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="submit" class="btn" name="add"> Save</button>
              </form>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" id="btn" data-dismiss="modal"><i class="fa fa-close"></i> Close</button>
              <button type="submit" id="bt" name="upload"><i class="fa fa-check-square-o"></i> Update</button>
              </form>
            </div>
        </div>
    </div>
